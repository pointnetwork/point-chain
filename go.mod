module github.com/pointnetwork/point-chain/v9
...
require (
	...
	github.com/tharsis/ethermint v0.6.1-0.20220919141022-34226aa7b1fa //TODO: update to ethermint v0.20.0 after it's released.
