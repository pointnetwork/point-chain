...
Learn how Point Chain handles pending state queries. {synopsis}
...
first-in-first-out (FIFO) fashion. Transactions on Point Chain cannot be ordered or cherry picked out from the Tendermint node [mempool](https://docs.tendermint.com/v0.34/tendermint-core/mempool.html).
