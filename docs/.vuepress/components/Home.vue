<template lang="pug">
  div
    ...
    .h2 Getting Started
    .p__alt Read all about Point or dive straight into the code with guides.
    .features
      router-link(to="/validators/overview").features__item.features__item__light
        ...
        .features__item__text
          ...
          .features__item__text__p Everything you need to know as an Point validator.
      router-link(to="/developers/overview").features__item.features__item__dark
        ...
        .features__item__text
          ...
          .features__item__text__p Find key information about developing on Point.
    .sections__wrapper
      .h2 Explore Point
      .p__alt Get familiar with Point and explore its main concepts.
      .sections
    ...
    .p__alt Check out the docs for the various parts of the Point stack.
    .stack
