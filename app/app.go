...
import (
	...
	ethermintapp "github.com/point/ethermint/app"
	...
	"github.com/point/ethermint/x/evm"
	evmkeeper "github.com/point/ethermint/x/evm/keeper"
	evmtypes "github.com/point/ethermint/x/evm/types"
	"github.com/point/ethermint/x/evm/vm/geth"
	"github.com/point/ethermint/x/feemarket"
	feemarketkeeper "github.com/point/ethermint/x/feemarket/keeper"
	feemarkettypes "github.com/point/ethermint/x/feemarket/types"

	// unnamed import of statik for swagger UI support
	_ "github.com/pointnetwork/point-chain/v9/client/docs/statik"
	...
	v8 "github.com/pointnetwork/point-chain/v9/app/upgrades/v8"
	v81 "github.com/pointnetwork/point-chain/v9/app/upgrades/v8_1"
	...
	"github.com/pointnetwork/point-chain/v9/x/epochs"
	epochskeeper "github.com/pointnetwork/point-chain/v9/x/epochs/keeper"
	epochstypes "github.com/pointnetwork/point-chain/v9/x/epochs/types"
	"github.com/pointnetwork/point-chain/v9/x/erc20"
	erc20client "github.com/pointnetwork/point-chain/v9/x/erc20/client"
	erc20keeper "github.com/pointnetwork/point-chain/v9/x/erc20/keeper"
	erc20types "github.com/pointnetwork/point-chain/v9/x/erc20/types"
	"github.com/pointnetwork/point-chain/v9/x/incentives"
	incentivesclient "github.com/pointnetwork/point-chain/v9/x/incentives/client"
	incentiveskeeper "github.com/pointnetwork/point-chain/v9/x/incentives/keeper"
	incentivestypes "github.com/pointnetwork/point-chain/v9/x/incentives/types"
	"github.com/pointnetwork/point-chain/v9/x/inflation"
	...
	"github.com/pointnetwork/point-chain/v9/x/recovery"
	recoverykeeper "github.com/pointnetwork/point-chain/v9/x/recovery/keeper"
	recoverytypes "github.com/pointnetwork/point-chain/v9/x/recovery/types"
	"github.com/pointnetwork/point-chain/v9/x/revenue"
	revenuekeeper "github.com/pointnetwork/point-chain/v9/x/revenue/keeper"
	revenuetypes "github.com/pointnetwork/point-chain/v9/x/revenue/types"
	"github.com/pointnetwork/point-chain/v9/x/vesting"
	vestingkeeper "github.com/pointnetwork/point-chain/v9/x/vesting/keeper"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".pointd")

	// manually update the power reduction by replacing micro (u) -> atto (a) point
...
func (app *Point) GetKey(storeKey string) *storetypes.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Point) GetTKey(storeKey string) *storetypes.TransientStoreKey {
...
func (app *Point) GetMemKey(storeKey string) *storetypes.MemoryStoreKey {
...
func (app *Point) GetStakingKeeper() ibctestingtypes.StakingKeeper {
	return app.StakingKeeper
}

// GetStakingKeeper implements the TestingApp interface.
func (app *Point) GetStakingKeeperSDK() stakingkeeper.Keeper {
	return app.StakingKeeper
}
