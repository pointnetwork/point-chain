...
func UpdateIBCClients(ctx sdk.Context, k ibcclientkeeper.Keeper) error {
	proposalOsmosis := &ibcclienttypes.ClientUpdateProposal{
		...
		Description:        "Update the existing expired Cosmos Hub IBC client on Point (07-tendermint-0) in order to resume packet transfers between both chains.",
	...
	proposalCosmosHub := &ibcclienttypes.ClientUpdateProposal{
		...
		Description:        "Update the existing expired Cosmos Hub IBC client on Point (07-tendermint-3) in order to resume packet transfers between both chains.",
