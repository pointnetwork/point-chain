...
const (
	...
	UpgradeInfo = `'{"binaries":{"darwin/arm64":"https://github.com/pointnetwork/point-chain/releases/download/v5.0.0/evmos_5.0.0_Darwin_arm64.tar.gz","darwin/x86_64":"https://github.com/pointnetwork/point-chain/releases/download/v5.0.0/evmos_5.0.0_Darwin_x86_64.tar.gz","linux/arm64":"https://github.com/pointnetwork/point-chain/releases/download/v5.0.0/evmos_5.0.0_Linux_arm64.tar.gz","linux/amd64":"https://github.com/pointnetwork/point-chain/releases/download/v5.0.0/evmos_5.0.0_Linux_x86_64.tar.gz","windows/x86_64":"https://github.com/pointnetwork/point-chain/releases/download/v5.0.0/evmos_5.0.0_Windows_x86_64.zip"}}'`
...
var (
	// MainnetMinGasPrices defines 20B apoint (or aupoint) as the minimum gas price value on the fee market module.
