...
func InitCmd(mbm module.BasicManager, defaultNodeHome string) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// Set default seeds
			seeds := []string{
				"40f4fac63da8b1ce8f850b0fa0f79b2699d2ce72@seed.point.jerrychong.com:26656",                 // jerrychong
				"e3e11fca4ecf4035a751f3fea90e3a821e274487@bd-point-mainnet-seed-node-01.bdnodes.net:26656", // blockdaemon
				"fc86e7e75c5d2e4699535e1b1bec98ae55b16826@bd-point-mainnet-seed-node-02.bdnodes.net:26656", // blockdaemon
			}
			...
			if chainID == "" {
				chainID = fmt.Sprintf("point_10687%v", tmrand.Str(6))
			}
