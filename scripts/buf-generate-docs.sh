...
# also make sure that you are added to the Point organization on buf
...
buf mod update $POINTPROTO

# then, push the point proto module and documentation 
buf push $POINTPROTO

# two commit addresses should be printed to the command line
# the point documentation will have links to the third party documentation
