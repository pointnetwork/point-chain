...
var (
	// SupportedAlgorithms defines the list of signing algorithms used on Point:
	//  - eth_secp256k1 (Ethereum)
	SupportedAlgorithms = keyring.SigningAlgoList{hd.EthSecp256k1}
	// SupportedAlgorithmsLedger defines the list of signing algorithms used on Point for the Ledger device:
	//  - eth_secp256k1 (Ethereum)
