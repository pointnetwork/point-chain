...
// source: point/revenue/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgRegisterRevenue)(nil), "point.revenue.v1.MsgRegisterRevenue")
	proto.RegisterType((*MsgRegisterRevenueResponse)(nil), "point.revenue.v1.MsgRegisterRevenueResponse")
	proto.RegisterType((*MsgUpdateRevenue)(nil), "point.revenue.v1.MsgUpdateRevenue")
	proto.RegisterType((*MsgUpdateRevenueResponse)(nil), "point.revenue.v1.MsgUpdateRevenueResponse")
	proto.RegisterType((*MsgCancelRevenue)(nil), "point.revenue.v1.MsgCancelRevenue")
	proto.RegisterType((*MsgCancelRevenueResponse)(nil), "point.revenue.v1.MsgCancelRevenueResponse")
}

func init() { proto.RegisterFile("point/revenue/v1/tx.proto", fileDescriptor_2a6d23524264890a) }
...
func (c *msgClient) RegisterRevenue(ctx context.Context, in *MsgRegisterRevenue, opts ...grpc.CallOption) (*MsgRegisterRevenueResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/point.revenue.v1.Msg/RegisterRevenue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateRevenue(ctx context.Context, in *MsgUpdateRevenue, opts ...grpc.CallOption) (*MsgUpdateRevenueResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/point.revenue.v1.Msg/UpdateRevenue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CancelRevenue(ctx context.Context, in *MsgCancelRevenue, opts ...grpc.CallOption) (*MsgCancelRevenueResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/point.revenue.v1.Msg/CancelRevenue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RegisterRevenue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/point.revenue.v1.Msg/RegisterRevenue",
	}
...
func _Msg_UpdateRevenue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/point.revenue.v1.Msg/UpdateRevenue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_CancelRevenue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/point.revenue.v1.Msg/CancelRevenue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "point.revenue.v1.Msg",
	...
	Metadata: "point/revenue/v1/tx.proto",
}
