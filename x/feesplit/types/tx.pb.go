...
// source: point/feesplit/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgRegisterFeeSplit)(nil), "point.feesplit.v1.MsgRegisterFeeSplit")
	proto.RegisterType((*MsgRegisterFeeSplitResponse)(nil), "point.feesplit.v1.MsgRegisterFeeSplitResponse")
	proto.RegisterType((*MsgUpdateFeeSplit)(nil), "point.feesplit.v1.MsgUpdateFeeSplit")
	proto.RegisterType((*MsgUpdateFeeSplitResponse)(nil), "point.feesplit.v1.MsgUpdateFeeSplitResponse")
	proto.RegisterType((*MsgCancelFeeSplit)(nil), "point.feesplit.v1.MsgCancelFeeSplit")
	proto.RegisterType((*MsgCancelFeeSplitResponse)(nil), "point.feesplit.v1.MsgCancelFeeSplitResponse")
}

func init() { proto.RegisterFile("point/feesplit/v1/tx.proto", fileDescriptor_ff74a11a6f0bacb5) }
...
func (c *msgClient) RegisterFeeSplit(ctx context.Context, in *MsgRegisterFeeSplit, opts ...grpc.CallOption) (*MsgRegisterFeeSplitResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/point.feesplit.v1.Msg/RegisterFeeSplit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateFeeSplit(ctx context.Context, in *MsgUpdateFeeSplit, opts ...grpc.CallOption) (*MsgUpdateFeeSplitResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/point.feesplit.v1.Msg/UpdateFeeSplit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CancelFeeSplit(ctx context.Context, in *MsgCancelFeeSplit, opts ...grpc.CallOption) (*MsgCancelFeeSplitResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/point.feesplit.v1.Msg/CancelFeeSplit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RegisterFeeSplit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/point.feesplit.v1.Msg/RegisterFeeSplit",
	}
...
func _Msg_UpdateFeeSplit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/point.feesplit.v1.Msg/UpdateFeeSplit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_CancelFeeSplit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/point.feesplit.v1.Msg/CancelFeeSplit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "point.feesplit.v1.Msg",
	...
	Metadata: "point/feesplit/v1/tx.proto",
}
