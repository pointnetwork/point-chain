...
// source: point/feesplit/v1/feesplit.proto
...
func init() {
	proto.RegisterType((*FeeSplit)(nil), "point.feesplit.v1.FeeSplit")
}

func init() { proto.RegisterFile("point/feesplit/v1/feesplit.proto", fileDescriptor_c47c481149a408b0) }
