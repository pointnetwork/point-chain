...
// source: point/feesplit/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "point.feesplit.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "point.feesplit.v1.Params")
}

func init() { proto.RegisterFile("point/feesplit/v1/genesis.proto", fileDescriptor_908469c9903cc008) }
