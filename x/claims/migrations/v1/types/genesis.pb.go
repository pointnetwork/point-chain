...
// source: point/claims/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "point.claims.migrations.v1.GenesisState")
	proto.RegisterType((*Params)(nil), "point.claims.migrations.v1.Params")
}

func init() { proto.RegisterFile("point/claims/v1/genesis.proto", fileDescriptor_f2f8f1d6f18af278) }
