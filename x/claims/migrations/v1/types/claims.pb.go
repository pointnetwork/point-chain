...
// source: point/claims/v1/claims.proto
...
type Claim struct {
	// action enum
	Action Action `protobuf:"varint,1,opt,name=action,proto3,enum=point.claims.v1.Action" json:"action,omitempty"`
...
func init() {
	proto.RegisterEnum("point.claims.migration.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "point.claims.migration.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "point.claims.migration.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "point.claims.migration.v1.ClaimsRecord")
}

func init() { proto.RegisterFile("point/claims/v1/claims.proto", fileDescriptor_a7153f2307523893) }
