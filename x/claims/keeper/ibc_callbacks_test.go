...
func (suite *KeeperTestSuite) TestAckknowledgementPacket() {
	...
	testCases := []struct {
		...
		},
		{
			...
			func() {
				addr, err := sdk.AccAddressFromBech32("point1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v")
				suite.Require().NoError(err)

				mockpacket.Data = transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "point1x2w87cvt5mqjncav4lxy8yfreynn273xn5335v",
...
func (suite *KeeperTestSuite) TestOnRecvPacket() {
	...
	senderStr := "point1sv9m0g7ycejwr3s369km58h5qe7xj77hvcxrms"
	receiverStr := "point1hf0468jjpe6m6vx38s97z2qqe8ldu0njdyf625"
	...
	testCases := []struct {
		...
		},
		{
			...
			func() {
				...
				transfer := transfertypes.NewFungibleTokenPacketData("apoint", "100", senderStr, blockedAddr.String())
		...
		},
		{
			...
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("apoint", "100", senderStr, receiverStr)
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
		...
		},
		{
			"fail - invalid sender",
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("apoint", "100", "point", receiverStr)
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
		...
		},
		{
			...
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("apoint", "100", "badba1sv9m0g7ycejwr3s369km58h5qe7xj77hvcxrms", receiverStr)
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
		...
		},
		{
			...
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("apoint", "100", receiverStr, "badbadhf0468jjpe6m6vx38s97z2qqe8ldu0njdyf625")
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
		...
		},
		{
			...
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("apoint", "100", secpAddrCosmos, secpAddrPoint)
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
		...
		},
		{
			...
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("apoint", types.IBCTriggerAmt, senderStr, receiverStr)
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
		...
		},
		{
			...
			func() {
				transfer := transfertypes.NewFungibleTokenPacketData("apoint", "100", secpAddrCosmos, receiverStr)
				bz := transfertypes.ModuleCdc.MustMarshalJSON(&transfer)
				packet := channeltypes.NewPacket(bz, 1, transfertypes.PortID, "channel-0", transfertypes.PortID, "channel-0", timeoutHeight, 0)
