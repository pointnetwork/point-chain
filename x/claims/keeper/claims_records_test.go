...
func (suite *KeeperTestSuite) TestsClaimsRecords() {
	addr1, err := sdk.AccAddressFromBech32("point1hf0468jjpe6m6vx38s97z2qqe8ldu0njdyf625")
	suite.Require().NoError(err)
	addr2, err := sdk.AccAddressFromBech32("point1sv9m0g7ycejwr3s369km58h5qe7xj77hvcxrms")
	suite.Require().NoError(err)
