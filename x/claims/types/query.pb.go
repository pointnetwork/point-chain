...
// source: point/claims/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryTotalUnclaimedRequest)(nil), "point.claims.v1.QueryTotalUnclaimedRequest")
	proto.RegisterType((*QueryTotalUnclaimedResponse)(nil), "point.claims.v1.QueryTotalUnclaimedResponse")
	proto.RegisterType((*QueryParamsRequest)(nil), "point.claims.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "point.claims.v1.QueryParamsResponse")
	proto.RegisterType((*QueryClaimsRecordsRequest)(nil), "point.claims.v1.QueryClaimsRecordsRequest")
	proto.RegisterType((*QueryClaimsRecordsResponse)(nil), "point.claims.v1.QueryClaimsRecordsResponse")
	proto.RegisterType((*QueryClaimsRecordRequest)(nil), "point.claims.v1.QueryClaimsRecordRequest")
	proto.RegisterType((*QueryClaimsRecordResponse)(nil), "point.claims.v1.QueryClaimsRecordResponse")
}

func init() { proto.RegisterFile("point/claims/v1/query.proto", fileDescriptor_f3bf523ec58a3aba) }
...
func (c *queryClient) TotalUnclaimed(ctx context.Context, in *QueryTotalUnclaimedRequest, opts ...grpc.CallOption) (*QueryTotalUnclaimedResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/point.claims.v1.Query/TotalUnclaimed", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/point.claims.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ClaimsRecords(ctx context.Context, in *QueryClaimsRecordsRequest, opts ...grpc.CallOption) (*QueryClaimsRecordsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/point.claims.v1.Query/ClaimsRecords", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ClaimsRecord(ctx context.Context, in *QueryClaimsRecordRequest, opts ...grpc.CallOption) (*QueryClaimsRecordResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/point.claims.v1.Query/ClaimsRecord", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_TotalUnclaimed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/point.claims.v1.Query/TotalUnclaimed",
	}
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/point.claims.v1.Query/Params",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ClaimsRecords_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/point.claims.v1.Query/ClaimsRecords",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_ClaimsRecord_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/point.claims.v1.Query/ClaimsRecord",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "point.claims.v1.Query",
	...
	Metadata: "point/claims/v1/query.proto",
}
