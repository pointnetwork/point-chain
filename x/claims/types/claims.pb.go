...
func init() {
	proto.RegisterEnum("point.claims.v1.Action", Action_name, Action_value)
	proto.RegisterType((*Claim)(nil), "point.claims.v1.Claim")
	proto.RegisterType((*ClaimsRecordAddress)(nil), "point.claims.v1.ClaimsRecordAddress")
	proto.RegisterType((*ClaimsRecord)(nil), "point.claims.v1.ClaimsRecord")
}
