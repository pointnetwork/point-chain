...
// source: point/vesting/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgCreateClawbackVestingAccount)(nil), "point.vesting.v1.MsgCreateClawbackVestingAccount")
	proto.RegisterType((*MsgCreateClawbackVestingAccountResponse)(nil), "point.vesting.v1.MsgCreateClawbackVestingAccountResponse")
	proto.RegisterType((*MsgClawback)(nil), "point.vesting.v1.MsgClawback")
	proto.RegisterType((*MsgClawbackResponse)(nil), "point.vesting.v1.MsgClawbackResponse")
}

func init() { proto.RegisterFile("point/vesting/v1/tx.proto", fileDescriptor_d5db113bc0c7240c) }
...
func (c *msgClient) CreateClawbackVestingAccount(ctx context.Context, in *MsgCreateClawbackVestingAccount, opts ...grpc.CallOption) (*MsgCreateClawbackVestingAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/point.vesting.v1.Msg/CreateClawbackVestingAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) Clawback(ctx context.Context, in *MsgClawback, opts ...grpc.CallOption) (*MsgClawbackResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/point.vesting.v1.Msg/Clawback", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateClawbackVestingAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/point.vesting.v1.Msg/CreateClawbackVestingAccount",
	}
...
func _Msg_Clawback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/point.vesting.v1.Msg/Clawback",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "point.vesting.v1.Msg",
	...
	Metadata: "point/vesting/v1/tx.proto",
}
