...
// source: point/vesting/v1/vesting.proto
...
func init() {
	proto.RegisterType((*ClawbackVestingAccount)(nil), "point.vesting.v1.ClawbackVestingAccount")
}

func init() { proto.RegisterFile("point/vesting/v1/vesting.proto", fileDescriptor_5f1a3c86c0cebe5f) }
