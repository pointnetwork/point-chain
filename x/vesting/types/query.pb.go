...
// source: point/vesting/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryBalancesRequest)(nil), "point.vesting.v1.QueryBalancesRequest")
	proto.RegisterType((*QueryBalancesResponse)(nil), "point.vesting.v1.QueryBalancesResponse")
}

func init() { proto.RegisterFile("point/vesting/v1/query.proto", fileDescriptor_ff0457b141ab5d28) }
...
var fileDescriptor_ff0457b141ab5d28 = []byte{
	...
	0x89, 0xce, 0x50, 0xbc, 0x78, 0x86, 0x5f, 0x20, 0x47, 0x6f, 0xd3, 0x76, 0x52, 0x1b, 0x60, 0x5e,
	...
	0x1a, 0x00, 0x00, 0xff, 0xff, 0x0c, 0xe0, 0x9b, 0x54, 0xe6, 0x02, 0x00, 0x00,
}
...
func (c *queryClient) Balances(ctx context.Context, in *QueryBalancesRequest, opts ...grpc.CallOption) (*QueryBalancesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/point.vesting.v1.Query/Balances", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Balances_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/point.vesting.v1.Query/Balances",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "point.vesting.v1.Query",
	...
	Metadata: "point/vesting/v1/query.proto",
}
