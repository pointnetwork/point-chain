...
// source: point/erc20/v1/erc20.proto
...
type TokenPair struct {
	...
	ContractOwner Owner `protobuf:"varint,4,opt,name=contract_owner,json=contractOwner,proto3,enum=point.erc20.v1.Owner" json:"contract_owner,omitempty"`
}
...
func init() {
	proto.RegisterEnum("point.erc20.v1.Owner", Owner_name, Owner_value)
	proto.RegisterType((*TokenPair)(nil), "point.erc20.v1.TokenPair")
	proto.RegisterType((*RegisterCoinProposal)(nil), "point.erc20.v1.RegisterCoinProposal")
	proto.RegisterType((*RegisterERC20Proposal)(nil), "point.erc20.v1.RegisterERC20Proposal")
	proto.RegisterType((*ToggleTokenConversionProposal)(nil), "point.erc20.v1.ToggleTokenConversionProposal")
}

func init() { proto.RegisterFile("point/erc20/v1/erc20.proto", fileDescriptor_668d5dc537f45142) }
