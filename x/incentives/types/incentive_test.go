...
func (suite *IncentiveTestSuite) TestIncentiveNew() {
	testCases := []struct {
	...
	}{
		{
			...
			sdk.DecCoins{sdk.NewDecCoinFromDec("apoint", sdk.NewDecWithPrec(5, 2))},
			10,
			true,
		},
		{
		...
		},
		{
			...
			tests.GenerateAddress(),
			sdk.DecCoins{sdk.NewDecCoinFromDec("apoint", sdk.NewDecWithPrec(0, 2))},
			10,
			false,
		},
		{
			...
			tests.GenerateAddress(),
			sdk.DecCoins{sdk.NewDecCoinFromDec("apoint", sdk.NewDecWithPrec(101, 2))},
			10,
			false,
		},
		{
