...
// source: point/incentives/v1/incentives.proto
...
func init() {
	proto.RegisterType((*Incentive)(nil), "point.incentives.v1.Incentive")
	proto.RegisterType((*GasMeter)(nil), "point.incentives.v1.GasMeter")
	proto.RegisterType((*RegisterIncentiveProposal)(nil), "point.incentives.v1.RegisterIncentiveProposal")
	proto.RegisterType((*CancelIncentiveProposal)(nil), "point.incentives.v1.CancelIncentiveProposal")
}

func init() {
	proto.RegisterFile("point/incentives/v1/incentives.proto", fileDescriptor_95b81e40854aec77)
}
